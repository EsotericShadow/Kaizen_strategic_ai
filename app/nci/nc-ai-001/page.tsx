...
export const metadata: Metadata = {
  title: 'NC-AI-001 AI Risk Register Template | ISO 42001 Aligned | Free Download | Northern Cascadia Institute',
  description: 'Download NC-AI-001 AI Risk Register Template free. Comprehensive AI risk management template with 28 pre-populated risks across 8 categories, aligned with ISO 42001:2023. Designed for smaller organizations in Northern BC.',
  keywords: [
    'NC-AI-001',
