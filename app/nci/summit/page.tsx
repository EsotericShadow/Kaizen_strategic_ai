...
export const metadata: Metadata = {
  title: 'Annual AI & Technology Summit Northern BC 2025 | AI Governance Conference | Terrace, BC | Northern Cascadia Institute',
  description: 'Annual AI & Technology Summit 2025 hosted by Northern Cascadia Institute in Terrace, BC. Full-day conference bringing together business leaders, government officials, Indigenous representatives, and technology experts for AI governance, digital strategy, and regional AI standards discussions.',
  keywords: [
    'AI summit Northern BC',
    'AI summit 2025',
    'AI conference Northern BC',
    'AI conference Terrace BC',
    'AI technology summit',
    'AI governance summit',
    'AI governance conference',
    'AI summit BC',
    'Northern BC AI event',
    'Northern BC AI conference',
    'Terrace BC AI summit',
    'Terrace BC AI conference',
    'AI & Technology Summit',
    'Northern Cascadia Institute summit',
    'AI governance event',
    'digital strategy conference',
    'regional AI summit',
    'Indigenous data sovereignty conference',
    'ISO 42001 conference',
    'AI standards conference',
    'NC-AI summit',
    'AI business conference Northern BC',
    'AI event Terrace',
    'AI networking event Northern BC',
  ].join(', '),
  openGraph: {
    title: 'Annual AI & Technology Summit Northern BC 2025 | Terrace, BC',
    description: 'Full-day AI & Technology Summit in Terrace, BC. AI governance, digital strategy, and regional AI standards.',
    type: 'website',
    locale: 'en_CA',
  },
  alternates: {
